<#
.SYNOPSIS
    Queues a run of a pipeline, on a branch if given.
.EXAMPLE
    ./scripts/Start-Pipeline.ps1 -Id 42 -Branch main
#>
[CmdletBinding()]
param(
...
Post-Api '/api/pipelines/queue' $payload | ConvertTo-Json -Depth 4
