<#
.SYNOPSIS
    Success rate (recent versus older), failures, average duration and the last 20 results of a pipeline.
.EXAMPLE
    ./scripts/Get-PipelineHealth.ps1 -Id 42
#>
[CmdletBinding()]
param(
...
Get-Api "/api/pipelines/health?id=$Id" | ConvertTo-Json -Depth 5
